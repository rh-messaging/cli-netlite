...
dotnet publish -f netcoreapp3.1 .\src\dotNetCore\NetCoreSender\NetCoreSender.csproj
dotnet publish -f netcoreapp3.1 .\src\dotNetCore\NetCoreReceiver\NetCoreReceiver.csproj
dotnet publish -f netcoreapp3.1 .\src\dotNetCore\NetCoreConnector\NetCoreConnector.csproj